...
export class TabsController {
  ...
  async updateTabItemQuantity(
    ...
    this.logger.log(
      `Updating item quantity in tab ID: ${id}, item index: ${itemIndex}`,
    );
  ...
  async removeTabItem(
    ...
    this.logger.log(
      `Removing item from tab ID: ${id}, item index: ${itemIndex}`,
    );
  ...
  async getTabs(
    ...
    this.logger.log(
      `Getting tabs with filters - status: ${status}, memberId: ${memberId}`,
    );
